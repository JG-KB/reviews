...
public class ReviewRepository {
	...
	public ReviewRepository() {
		Review jaylenReviewOne = new Review(0101L, "LeBron the Free Agent:", "/img/lebron.jpg", "SportsWorld",
		...
		Review jaylenReviewTwo = new Review(0202L, "We Can Code It:", "/img/jaylen-can-code-it.jpg", "CodingBootcamp",
		...
		Review jaylenReviewThree = new Review(0303L, "SnakeHead Fish:", "/img/snakeHead.jpg", "CarnivoreThoughts",
